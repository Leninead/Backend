...
//     if (productIndex !== -1) {
//       const updatedProduct = { ...this.products[productIndex], ...updatedFields }; // Actualizar el producto con los nuevos campos
...
//   productManager.addProduct({
//     title: "Producto 2",
//     description: "Guitarra eléctrica Fender Player Stratocaster de aliso 3-color sunburst brillante con diapasón de granadillo brasileño",
//     price: 688.999,
